...
const downloadPdf = async (req, res) => {
  ...
  res.setHeader("Content-Type", "application/pdf");
  res.setHeader("Content-Disposition", contentDisposition(filePath.replace("ticket", "transaction")));

  const stream = fs.createReadStream(filePath);
  stream.pipe(res);
};

module.exports = { exportTransaction, printPdf, downloadPdf, printTransaction };
